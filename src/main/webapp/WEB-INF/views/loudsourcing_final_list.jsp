...
<head>
    ...
    <title>크라우드 관리 - 최종 선정 인원 리스트</title>
    <!-- core:css -->
        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">최종 선정 인원 리스트</li>
                </ol>
            </nav>
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table id="dataTableExample" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                    class="btn btn-outline-primary btn-icon-text mr-2 mb-2 mb-md-0"
                                                    onclick="if(confirm('아티스트 명 : ${artistList[i-1].artist_name}\n\n해당 유저에게 선정 알림을 보내시겠습니까?')){sendFinalSelectedAlarm(${artistList[i-1].loudsourcing_no}, ${artistList[i-1].artist_no});} else {return false;}">
                                                <i class="btn-icon-prepend" data-feather="send"></i>
                                                보내기
                                            </button>
                                        </td>
                            ...
                            <div class="row mt-3 mb-3">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-outline-primary btn-icon-text mr-2 mb-2 mb-md-0" style="float: right" onclick="location.href='/admin/loudsourcing/end.do'">
                                        뒤로가기
                                    </button>
                                </div>
                            </div>
...
<script>
    function sendFinalSelectedAlarm(loudsourcing_no, artist_no) {
    ...
    function sendFinalSelectedAlarmToAll(loudsourcing_no) {
