        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title" style="font-size: x-large">후원 관리</h6>
                                        ...
                                        <div class="row mt-3 justify-content-around">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <textarea class="form-control" id="spon-price" rows="1"
                                                          style="line-height: 150%; font-size: large"
                                                          disabled><fmt:formatNumber value="${spon.price}" type="number"/>원</textarea>
                                            </div>
                                        </div>
                                        <div class="row mt-3 justify-content-around">
                                            <div class="col-md-5">
                                                ...
                                                <textarea class="form-control" id="spon-status" rows="1"
                                                          style="line-height: 150%; font-size: large"
                                                          disabled><c:choose><c:when test="${spon.status == false}">미승인</c:when><c:when test="${spon.status == true}">승인</c:when></c:choose></textarea>
                                            </div>
                                            <div class="col-md-5">
                                                ...
                                                <textarea class="form-control" id="send-price" rows="1"
                                                          style="line-height: 150%; font-size: large"
                                                          disabled><fmt:formatNumber value="${spon.price_send}" type="number"/>원</textarea>
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-3 justify-content-around">
                                            <div class="col-md-5">
                                                ...
                                                <textarea class="form-control" id="spon-type" rows="1"
                                                          style="line-height: 150%; font-size: large"
                                                          disabled><c:choose><c:when test="${spon.type == 'Board Spon'}">게시글 후원</c:when><c:when test="${spon.type == 'Artist Spon'}">아티스트 후원</c:when></c:choose></textarea>
                                            </div>
                                            <div class="col-md-5">
