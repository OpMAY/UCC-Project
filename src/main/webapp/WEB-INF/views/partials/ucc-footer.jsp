...
<%--                </div>--%>
            ...
            <div class="col-12 col-lg-3 d-flex flex-column justify-content-between">
                <div class="row justify-content-start justify-content-md-end mt-3 align-items-center" style="gap: 5%; margin-right: 5px;">
                    <a href="https://www.youtube.com/channel/UCZhr-cQ1gPZBLr2djJNDNKg" target="_blank"><img class="media1" src="/assets/images/ucc/footer-youtube.svg"></a>
                    <a href="https://www.instagram.com/we_art_collection/?hl=ko" target="_blank"><img class="media2" src="/assets/images/ucc/footer-instagram.svg"></a>
                </div>
                <div class="row justify-content-start justify-content-md-end mt-3">
                    <div class="col-4 p-0">
                        <a href="https://play.google.com/store/apps/details?id=com.weart.ucc"><img src="/assets/images/ucc/google-play-button.png" width="100%"></a>
                    </div>
                    <div class="col-4 p-0">
                        <a href="https://apps.apple.com/kr/app/ucc/id1580818238"><img src="/assets/images/ucc/apple-store-button.png" width="100%"></a>
                    </div>
                </div>
            </div>
        </div>
