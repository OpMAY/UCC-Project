			...
			<div class="page-content">
				<div class="row">
					<div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
						...
						<p class="lead">Construct highly repetitive components like blog comments, tweets, and the like. Read the <a href="https://getbootstrap.com/docs/4.3/components/media-object/media-object.jsp" target="_blank">Official Bootstrap Documentation</a> for a full list of instructions and other options.</p>
						...
						<div class="example">
							<div class="media d-block d-sm-flex">
								<img src="../../../assets/images/placeholder.jpg" class="wd-100p wd-sm-200 mb-3 mb-sm-0 mr-3" alt="...">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
	...
	<div class="media-body">
		...
		<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
						...
						<div class="example">
							<div class="media d-block d-sm-flex">
								<img src="../../../assets/images/placeholder.jpg" class="wd-100p wd-sm-150 mb-3 mb-sm-0 mr-3" alt="...">
								<div class="media-body">
									<h5 class="mt-0">Media heading</h5>
		...
		<div class="media d-block d-sm-flex mt-3">
			...
			<div class="media-body">
				...
				Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
						...
						<div class="example">
							<div class="media d-block d-sm-flex">
								<img src="../../../assets/images/placeholder.jpg" class="wd-100p mb-3 mb-sm-0 align-self-start mr-3 wd-sm-150" alt="...">
								<div class="media-body">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
	...
	<div class="media-body">
		...
		<p>Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
						...
						<div class="example">
							<div class="media d-block d-sm-flex">
								<img src="../../../assets/images/placeholder.jpg" class="align-self-center wd-100p wd-sm-150 mb-3 mb-sm-0 mr-3" alt="...">
								<div class="media-body">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
	...
	<div class="media-body">
		...
						...
						<div class="example">
							<div class="media d-block d-sm-flex">
								<img src="../../../assets/images/placeholder.jpg" class="align-self-end wd-100p wd-sm-150 mb-3 mb-sm-0 mr-3" alt="...">
								<div class="media-body">
		...
		...
						...
						<div class="example">
							<div class="media d-block d-sm-flex">
								...
								<img src="../../../assets/images/placeholder.jpg" class="wd-100p wd-sm-150 mb-3 mb-sm-0 ml-3" alt="...">
							</div>
						</div>
