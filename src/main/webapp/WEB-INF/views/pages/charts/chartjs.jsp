          ...
          <div class="col-md-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <p>Simple yet flexible JavaScript charts. Read the <a href="https://www.chartjs.org/chartjs.jsp" target="_blank"> Official Chart.js Documentation</a> for a full list of instructions and other options.</p>
              </div>
            </div>
          </div>
        </div>
