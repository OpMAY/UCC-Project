        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><c:choose><c:when
                            test="${type == 'loudsourcing'}">크라우드 문의</c:when><c:when
                            test="${type == 'normal'}">기타 문의</c:when></c:choose></li>
                </ol>
            </nav>
