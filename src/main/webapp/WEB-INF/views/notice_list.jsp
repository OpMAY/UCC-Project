        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title" style="font-size: x-large">공지사항<a style="margin-left: 10px"
                                ...
                                <table id="dataTableExample" class="table" style="table-layout: fixed">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                    class="btn btn-outline-primary btn-icon-text mr-2 mb-2 mb-md-0"
                                                    onclick="if(confirm('${i}번째 공지사항을 삭제하시겠습니까?')){deleteNotice(${noticeList[i-1].notice_no});} else {return false;}">
...
<script>
    function openWindowPopNotice(url, name){
