                            ...
                            <div class="card" style="background-color: #FFFFFf; border-radius: 1.5%">
                                <div class="card-body">
                                    ...
                                    <c:if test="${inquiry.type == 'loudsourcing'}">
                                        <div class="alert alert-primary d-flex justify-content-center mb-2"
                                             style="color: #5a6780; font-size: large">
                                            ...
                                            며칠 안으로 입력하신 연락처 혹은 이메일로 연락드리겠습니다.<br>
                                            앞으로도 많은 문의 보내주세요.<br>
                                        </div>
                                    </c:if>
                                            ...
                                            <div class="row mt-3 justify-content-center">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="inquiry-reported-user"
                                                              rows="1"
                                                              style="line-height: 150%; font-size: large"
                                                              disabled><c:choose><c:when test="${inquiry.reported_user_name == null}">삭제된 유저</c:when><c:when test="${inquiry.reported_user_name != null}">${inquiry.reported_user_name}</c:when></c:choose></textarea>
                                                </div>
                                            </div>
                                        </c:when>
                                                    ...
                                                    <div class="row mt-3 justify-content-center">
                                                        <div class="col-md-12">
                                                            <label class="label d-flex"
                                                                   for="inquiry-loudsourcing-answer-date"
                                                                   style="font-size: large">
                                                                답변 일자
                                                            </label>
                                                            <textarea class="form-control"
                                                                      id="inquiry-loudsourcing-answer-date"
                                                                      rows="1"
                                                                      style="line-height: 150%; font-size: large"
