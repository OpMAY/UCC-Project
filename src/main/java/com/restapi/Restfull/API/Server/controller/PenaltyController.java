...
public class PenaltyController {
    ...
    @RequestMapping(value = "/api/penalty/{user_no}", method = RequestMethod.GET)
    public ResponseEntity GetPenalty(@PathVariable("user_no") int user_no){
        return penaltyService.getPenaltyInfo(user_no);
    }
}
